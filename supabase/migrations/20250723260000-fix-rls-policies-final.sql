-- Migration pour corriger définitivement les politiques RLS
-- Date: 2025-07-23

-- 1. Supprimer toutes les anciennes politiques qui pourraient bloquer
...
-- 3. Créer des politiques RLS très permissives pour permettre la publication
