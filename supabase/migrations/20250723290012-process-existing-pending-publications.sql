-- Traiter manuellement les publications existantes qui sont restées en statut pending
-- Cette migration traite toutes les user_publications avec statut 'pending' qui existent déjà
...
DECLARE
    ...
    random_color TEXT;
BEGIN
    -- Traiter toutes les publications en attente existantes
    ...
    RAISE NOTICE 'Publications traitées: %', processed_count;
END $$; 