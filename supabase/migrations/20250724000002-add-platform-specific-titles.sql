-- Migration pour ajouter des titres spécifiques à chaque plateforme
-- Date: 2025-07-24

-- Mettre à jour les titres existants pour qu'ils soient compatibles avec toutes les plateformes
UPDATE content_titles 
SET platform = 'all' 
WHERE platform IS NULL;

-- Ajouter des titres spécifiques à TikTok
...
-- Ajouter des titres spécifiques à Instagram
INSERT INTO content_titles (title, subcategory_id, platform, created_at) VALUES
...
-- Ajouter des titres spécifiques à YouTube
INSERT INTO content_titles (title, subcategory_id, platform, created_at) VALUES
...
-- Ajouter des titres spécifiques à LinkedIn
INSERT INTO content_titles (title, subcategory_id, platform, created_at) VALUES
