-- Migration pour le système de profil utilisateur
...
-- Insérer quelques réseaux sociaux par défaut pour les utilisateurs existants
-- (Cette partie sera exécutée via l'application, pas dans la migration)
