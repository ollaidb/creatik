-- Migration pour créer le système de sous-catégories niveau 2
-- Date: 2025-01-27

-- 1. Créer la table subcategories_level2
CREATE TABLE public.subcategories_level2 (
...
CREATE TABLE public.category_hierarchy_config (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_subcategories_level2_subcategory_id ON public.subcategories_level2(subcategory_id);
CREATE INDEX idx_category_hierarchy_config_category_id ON public.category_hierarchy_config(category_id);
