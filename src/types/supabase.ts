  ...
  public: {
    Tables: {
      ...
      pending_publications: {
        ...
        Relationships: [
          {
            foreignKeyName: "pending_publications_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pending_publications_subcategory_id_fkey"
            columns: ["subcategory_id"]
            isOneToOne: false
            referencedRelation: "subcategories"
            referencedColumns: ["id"]
    ...
    Functions: {
      add_to_trash: {
        Args: {
          p_user_id: string
          p_original_publication_id: string
      ...
      process_pending_publications: {
        Args: Record<PropertyKey, never>
        Returns: Json
      }
      process_user_publications: {
        Args: Record<PropertyKey, never>
        Returns: Json
      }
      reject_publication: {
