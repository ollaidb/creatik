-- Script pour exécuter les tables du système de profil utilisateur
-- Exécutez ce script dans votre base de données Supabase

\echo 'Création des tables du système de profil utilisateur...'
...
-- RLS Policies
\echo 'Configuration des politiques RLS...'
...
DROP POLICY IF EXISTS "Users can create their own social accounts" ON public.user_social_accounts;
...
DROP POLICY IF EXISTS "Users can view their own social posts" ON public.user_social_posts;
DROP POLICY IF EXISTS "Users can create their own social posts" ON public.user_social_posts;
DROP POLICY IF EXISTS "Users can update their own social posts" ON public.user_social_posts;
DROP POLICY IF EXISTS "Users can delete their own social posts" ON public.user_social_posts;
...
DROP POLICY IF EXISTS "Users can view their own playlist posts" ON public.playlist_posts;
DROP POLICY IF EXISTS "Users can create their own playlist posts" ON public.playlist_posts;
DROP POLICY IF EXISTS "Users can update their own playlist posts" ON public.playlist_posts;
DROP POLICY IF EXISTS "Users can delete their own playlist posts" ON public.playlist_posts;
...
DROP TRIGGER IF EXISTS update_user_social_posts_updated_at ON public.user_social_posts;
DROP TRIGGER IF EXISTS update_user_content_playlists_updated_at ON public.user_content_playlists;
...
\echo 'Système de profil utilisateur configuré avec succès!'
