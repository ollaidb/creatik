-- Suppression complète de toutes les restrictions d'authentification
-- Date: 2025-01-27
...
CREATE POLICY IF NOT EXISTS "Universal read access" ON categories
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON subcategories
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON content_titles
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON sources
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON accounts
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON title_templates
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON title_variables
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON generated_titles
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON search_suggestions
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON generation_prompts
  FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Universal read access" ON ai_generation_history
  FOR SELECT USING (true);

-- Accès en écriture pour tous les utilisateurs authentifiés
CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON categories
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON subcategories
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON content_titles
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON sources
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON accounts
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON title_templates
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON title_variables
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON generated_titles
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON search_suggestions
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON generation_prompts
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Authenticated users can write" ON ai_generation_history
  FOR ALL USING (auth.role() = 'authenticated');

-- Politiques pour les tables utilisateur (accès personnel)
CREATE POLICY IF NOT EXISTS "Users can manage their own data" ON user_publications
  FOR ALL USING (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Users can manage their own data" ON user_favorites
  FOR ALL USING (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Users can manage their own data" ON user_preferences
  FOR ALL USING (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Users can manage their own data" ON profiles
