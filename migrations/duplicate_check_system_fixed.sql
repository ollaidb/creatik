-- Système de vérification des doublons avec délai de traitement (version corrigée)
...
-- 7. Créer un job pour traiter les publications (à exécuter manuellement ou via cron)
