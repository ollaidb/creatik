-- Migration pour publier directement le contenu sans approbation admin (version corrigée)
...
-- Insérer automatiquement le contenu des publications existantes (sans ON CONFLICT pour éviter les erreurs)
INSERT INTO categories (name, description, color)
...
-- 6. Politique RLS pour permettre aux utilisateurs de voir leurs publications
